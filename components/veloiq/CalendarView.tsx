...
export function CalendarView({ races, activities, ftp }: CalendarViewProps) {
  const router = useRouter();
  return <Calendar races={races} activities={activities} ftp={ftp} onRaceClick={() => router.push('/races')} />;
}

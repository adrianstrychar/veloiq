      ...
      <ResponsiveContainer width="100%" height={104}>
        <ComposedChart data={chart} margin={{ top: 10, right: 8, left: 8, bottom: 0 }}>
          ...
          {/* PROGNOZA + podpis zakotwiczone do STYKU (todayT = początek przerywanego odcinka), a nie
              do piksela rogu — czysto od wartości końcowej i najbliższego marka. textAnchor="end" →
              etykieta rozciąga się w LEWO nad ogonem historii. viewBox.x = piksel todayT z Recharts. */}
          <ReferenceLine
            x={todayT}
            stroke={C.border}
            strokeDasharray="4 4"
